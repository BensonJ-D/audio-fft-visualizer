...
namespace render {
    Shader::Shader(std::string vertexPath, std::string fragmentPath)
    {
        ...
        //fs::path vertexPath = vertexPath, fragmentPath = fragmentPathString;
    ...
    void Shader::checkCompileErrors(unsigned int shader, ShaderType type)
    {
        ...
        if (type != ShaderType::Program)
        {
            ...
            if (!success)
            {
                ...
                std::cout << "ERROR::SHADER_COMPILATION_ERROR of type: " << char(type) << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
        else
        {
            ...
            if (!success)
            {
                ...
                std::cout << "ERROR::PROGRAM_LINKING_ERROR of type: " << char(type) << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
    }
}
